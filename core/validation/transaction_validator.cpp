...
bool signaturesAreValid(const std::unique_ptr<abstract_transaction::AbstractTransaction> tx) {
...
bool validForType(const std::unique_ptr<abstract_transaction::AbstractTransaction> tx) {
