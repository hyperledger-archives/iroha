...
enum ProgrammingLanguage {
  ...
  ProgrammingLanguage_MIN = ProgrammingLanguage_Java8,
  ProgrammingLanguage_MAX = ProgrammingLanguage_Java8
};
...
enum UserPermission {
  UserPermission_NONE = 0,
  UserPermission_UserPermissionRoot = 1,
  UserPermission_UserPermissionLedger = 2,
  UserPermission_UserPermissionDomain = 3,
  UserPermission_UserPermissionAsset = 4,
  UserPermission_MIN = UserPermission_NONE,
  UserPermission_MAX = UserPermission_UserPermissionAsset
};
...
template<typename T> struct UserPermissionTraits {
  static const UserPermission enum_value = UserPermission_NONE;
};

template<> struct UserPermissionTraits<UserPermissionRoot> {
  static const UserPermission enum_value = UserPermission_UserPermissionRoot;
};

template<> struct UserPermissionTraits<UserPermissionLedger> {
  static const UserPermission enum_value = UserPermission_UserPermissionLedger;
};

template<> struct UserPermissionTraits<UserPermissionDomain> {
  static const UserPermission enum_value = UserPermission_UserPermissionDomain;
};

template<> struct UserPermissionTraits<UserPermissionAsset> {
  static const UserPermission enum_value = UserPermission_UserPermissionAsset;
};
...
inline flatbuffers::Offset<Chaincode> CreateChaincode(
    ...
    ProgrammingLanguage language = ProgrammingLanguage_Java8,
...
inline bool VerifyUserPermission(flatbuffers::Verifier &verifier, const void *obj, UserPermission type) {
  switch (type) {
    case UserPermission_NONE: {
      return true;
    }
    case UserPermission_UserPermissionRoot: {
      auto ptr = reinterpret_cast<const UserPermissionRoot *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case UserPermission_UserPermissionLedger: {
      auto ptr = reinterpret_cast<const UserPermissionLedger *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case UserPermission_UserPermissionDomain: {
      auto ptr = reinterpret_cast<const UserPermissionDomain *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case UserPermission_UserPermissionAsset: {
