...
inline flatbuffers::Offset<void> CreateCommandDirect(flatbuffers::FlatBuffersBuilder &_fbb, const void *obj, Command type) {
  switch (type) {
    case Command_NONE: {
      return nullptr;
    }
...
template<typename T> const T *GetRootWithEnum(flatbuffers::FlatBuffersBuilder &_fbb, const void *obj, Command type) {
  switch (type) {
    case Command_NONE: {
      return nullptr;
    }
