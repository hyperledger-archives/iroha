...
public class TestDomain {
  ...
  public static void testAddDomain(HashMap<String, String> params) throws IllegalStateException {
    try {
      ...
      HashMap<String, String> domainMap = repository.domainFindByUuid(uuid);
  ...
  public static void testUpdateDomain(String uuid, HashMap<String, String> params) throws IllegalStateException {
    try {
      // Print received params
      System.out.println("----------------------------------------------");
      System.out.println("Params domainName: " + params.get(DomainName));
  ...
  public static void testRemoveDomain(String uuid) throws IllegalStateException {
    try {
      // Print received params
      System.out.println("----------------------------------------------");
      ...
      if (!repository.domainRemove(uuid))
